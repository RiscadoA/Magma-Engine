...
namespace Magma
{
	...
	/// <summary>
	///		Standard implementation of Console interface
	/// </summary>
	...
	{
		delete s_activeConsole.m_console;
		try
		{
			s_activeConsole.m_console = new T();
		}
		catch (std::runtime_error& err)
		{
			s_activeConsole.m_console = new STDConsole();
			MAGMA_ERROR("Caught runtime error on console init\n" + std::string(err.what()));
		}
	}
}
