...
Magma::Console::ConsoleHandle Magma::Console::s_activeConsole = new STDConsole();
...
void Magma::STDConsole::DPrint(const std::string & text)
{
	fprintf(stdout, "%s", text.c_str());
}

void Magma::STDConsole::DPrintLn(const std::string & text)
{
	fprintf(stdout, "%s\n", text.c_str());
}

void Magma::STDConsole::DError(const std::string & text)
{
	fprintf(stderr, "%s", text.c_str());
}

void Magma::STDConsole::DWarning(const std::string & text)
{
	fprintf(stderr, "%s", text.c_str());
}

void Magma::STDConsole::DClear()
{
	MAGMA_WARNING("Failed to clear because STDConsole has no implementation for it");
}
